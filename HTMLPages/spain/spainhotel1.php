...
<head>
    ...
    <link rel="stylesheet" href="./spainhotel.css">
</head>
        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./moreinfospainimage/spainhotel11.jpeg">
                ...
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./moreinfospainimage/spainhotel12.jpeg">
                    <p>Double bed, AC</p>
                ...
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./moreinfospainimage/spainhotel13.jpeg">
