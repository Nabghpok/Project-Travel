...
<head>
    ...
    <link rel="stylesheet" href="./egypthotel.css">
</head>
<body>
    <header>
        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./moreinfoegyptimage/egypthotel11.jpeg">
                ...
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./moreinfoegyptimage/egypthotel12.jpeg">
                    <p>Double bed, AC</p>
                ...
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./moreinfoegyptimage/egypthotel13.jpeg">
