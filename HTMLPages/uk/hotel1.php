        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./readmoreukimage/hotel21.jpeg">
                    <p>Single bed, non-AC</p>
                    <p>Price: ₹30 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./readmoreukimage/hotel22.jpeg">
                    <p>Double bed, AC</p>
                    <p>Price: ₹112 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./readmoreukimage/hotel23.jpeg">
