...
<head>
    ...
    <link rel="stylesheet" href="./citybook.css">
</head>
        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./readmorenepalimage/cityhotel.jpeg">
                    <p>Single bed, non-AC</p>
                    <p>Price: Rs1,300 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./readmorenepalimage/acroom.jpeg">
                    <p>Double bed, AC</p>
                    <p>Price: Rs1,900 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./readmorenepalimage/deluxeroom.jpeg">
                    <p>King-size bed, AC, luxury amenities</p>
                    <p>Price: Rs2,300 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
            </ul>
        </section>
