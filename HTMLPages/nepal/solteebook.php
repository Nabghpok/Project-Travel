...
<head>
    ...
    <link rel="stylesheet" href="./solteebook.css">
</head>
<body>
    <header>
        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./readmorenepalimage/solteehotel1.jpeg">
                    <p>Single bed, non-AC</p>
                    <p>Price: Rs1,500 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./readmorenepalimage/solteehotel2.jpeg">
                    <p>Double bed, AC</p>
                    <p>Price: Rs2,000 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./readmorenepalimage/solteehotel3.jpeg">
                    <p>King-size bed, AC, luxury amenities</p>
                    <p>Price: Rs2,500 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
            </ul>
        </section>
