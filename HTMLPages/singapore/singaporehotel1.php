        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./readmoresingaporeimage/singaporehotel11.jpeg">
                ...
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./readmoresingaporeimage/singaporehotel12.jpeg">
                    <p>Double bed, AC</p>
                ...
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./readmoresingaporeimage/singaporehotel13.jpeg">
                    <p>King-size bed, AC, luxury amenities</p>
                    <p>Price: ₹135 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
            </ul>
        </section>
