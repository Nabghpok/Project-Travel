...
<head>
    ...
    <link rel="stylesheet" href="./switzerlandhotel.css">
</head>
        ...
        <section class="room-list">
            ...
            <ul id="room-list">
                <li class="normal-room">
                    <h3>Normal Room</h3>
                    <img src="./readmoreswitzerlandimage/switzerlandhotel21.jpeg">
                ...
                <li class="ac-room">
                    <h3>AC Room</h3>
                    <img src="./readmoreswitzerlandimage/switzerlandhotel22.jpeg">
                    <p>Double bed, AC</p>
                ...
                <li class="deluxe-room">
                    <h3>Deluxe Room</h3>
                    <img src="./readmoreswitzerlandimage/switzerlandhotel23.jpeg">
                    <p>King-size bed, AC, luxury amenities</p>
                    <p>Price: ₹160 per night</p>
                    <button class="book-now">Book Now</button>
                </li>
            </ul>
        </section>
